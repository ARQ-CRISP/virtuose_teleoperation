...
####
# You need to provide two parameters: record_folder which is the path where you want your rosbag to be recorded, 
# and record_script which is the path of your record bash script (this is simply a bash script with the command
# rosbag record and the list of topics you want to record).
###

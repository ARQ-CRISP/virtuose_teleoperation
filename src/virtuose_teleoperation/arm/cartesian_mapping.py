...
#            print(current_pose.p.x)
        ...
        #self.current_posenew = fromTf(transform_to_vec(self.tf_buffer.lookup_transform(
           #'world', 'hand_root', rospy.Time.now(), rospy.Duration(0.1))))
        #rospy.loginfo(self.current_posenew)
